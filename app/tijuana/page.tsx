...
export const metadata: Metadata = {
  ...
  keywords: [
    "invitaciones digitales tijuana",
    "invitaciones boda tijuana",
    "invitaciones xv años tijuana",
    "invitaciones digitales baja california",
...
const benefits = [
  {
    title: "Estilo binacional, identidad mexicana",
    desc: "En la frontera se mezclan dos culturas y eso hace que cada fiesta sea especial. Diseñamos invitaciones que honran la identidad tijuanense — modernas, audaces y con la calidez mexicana que define tus celebraciones.",
  },
  {
    title: "Invitados de ambos lados",
    desc: "¿Tienes familia en San Diego y en Tijuana? Nuestras invitaciones digitales llegan al instante a cualquier lado de la frontera. Incluyen mapa GPS, indicaciones y se pueden compartir por WhatsApp o texto.",
  },
  {
    title: "Todo en línea, sin cruzar",
    desc: "Nos contactas por WhatsApp, nos envías los datos y en 24 horas tienes tu invitación. Sin citas presenciales, sin trámites — perfecto para el ritmo de vida fronterizo.",
  },
  {
    title: "Actualizaciones en tiempo real",
    desc: "Si cambia la ubicación del evento o se ajusta el horario, modificamos la invitación al momento. El enlace sigue siendo el mismo y todos ven la información correcta.",
  },
]
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Invitaciones Digitales Tijuana",
  provider: {
    "@type": "LocalBusiness",
  ...
  description:
    "Invitaciones digitales para bodas, XV años y eventos en Tijuana con RSVP automático y entrega en 24 horas.",
  url: "https://invitacionesdigitalesmty.com.mx/tijuana",
}
...
export default function InvitacionesDigitalesTijuanaPage() {
  return (
    <>
      <script
          ...
          <div className="container mx-auto px-6 md:px-10 max-w-7xl flex-1 flex flex-col justify-between">
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="text-[11px] tracking-[0.3em] text-muted-foreground uppercase font-medium">
                Servicio 100% en línea desde Monterrey para Tijuana
              </span>
            </div>
            ...
            >
              Invitaciones<br />
              Digitales<br />
              <em className="italic text-primary">Tijuana</em>
            </h1>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12 border-t border-border pt-10">
              <div className="flex flex-col gap-8 max-w-md">
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Tijuana celebra sin fronteras — y tu invitación tampoco debería tener límites. Diseñamos invitaciones digitales con el espíritu fronterizo que define a la ciudad, te atendemos por WhatsApp, las entregamos en 24 horas y el boceto va por nuestra cuenta.
                </p>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-6 md:px-10 max-w-7xl">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-16">
              Invitaciones digitales sin fronteras para Tijuana
            </h2>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-6 md:px-10 max-w-7xl text-center">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">
              Cruza la línea del papel — invita en digital desde Tijuana
            </h2>
            <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">
              Mándanos un WhatsApp con la fecha y tipo de evento. Te regresamos un boceto personalizado gratis en minutos.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
