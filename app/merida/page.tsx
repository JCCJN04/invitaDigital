...
export const metadata: Metadata = {
  ...
  keywords: [
    "invitaciones digitales merida",
    "invitaciones boda merida yucatan",
    "invitaciones xv años merida",
    "invitaciones digitales yucatan",
...
const benefits = [
  {
    title: "Encanto yucateco en cada píxel",
    desc: "Creamos invitaciones que reflejan la magia de Mérida — desde bodas al atardecer en haciendas henequeneras hasta fiestas familiares en el Paseo de Montejo. Cada diseño respira la esencia del sureste.",
  },
  {
    title: "Confirmaciones automáticas",
    desc: "Tus invitados tocan un botón para confirmar asistencia y tú recibes la notificación en WhatsApp. Ideal para coordinar eventos donde los invitados vienen de distintos puntos de la Península.",
  },
  {
    title: "Sin necesidad de reunirnos en persona",
    desc: "Todo el proceso es por WhatsApp y correo. Nos envías los datos de tu evento desde Mérida y en 24 horas recibes tu invitación digital terminada, lista para compartir.",
  },
  {
    title: "Información siempre vigente",
    desc: "Si la hacienda cambia de horario o hay un ajuste de última hora, editamos la invitación al instante. Tus invitados siempre ven los datos correctos sin que tengas que reenviar el enlace.",
  },
]
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Invitaciones Digitales Mérida",
  provider: {
    "@type": "LocalBusiness",
  ...
  description:
    "Invitaciones digitales para bodas, XV años y eventos en Mérida con RSVP automático y entrega en 24 horas.",
  url: "https://invitacionesdigitalesmty.com.mx/merida",
}
...
export default function InvitacionesDigitalesMeridaPage() {
  return (
    <>
      <script
          ...
          <div className="container mx-auto px-6 md:px-10 max-w-7xl flex-1 flex flex-col justify-between">
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="text-[11px] tracking-[0.3em] text-muted-foreground uppercase font-medium">
                Servicio 100% en línea desde Monterrey para Mérida
              </span>
            </div>
            ...
            >
              Invitaciones<br />
              Digitales<br />
              <em className="italic text-primary">Mérida</em>
            </h1>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12 border-t border-border pt-10">
              <div className="flex flex-col gap-8 max-w-md">
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Mérida es la capital de las bodas destino en México, y cada celebración yucateca merece una invitación a la altura. Te diseñamos una invitación digital personalizada — todo por WhatsApp, con entrega en 24 horas y boceto gratis para empezar.
                </p>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-6 md:px-10 max-w-7xl">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-16">
              Invitaciones con la calidez del sureste mexicano
            </h2>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-6 md:px-10 max-w-7xl text-center">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">
              Tu boda o evento en Mérida comienza con la invitación perfecta
            </h2>
            <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">
              Escríbenos por WhatsApp con los datos de tu celebración. Te enviamos un boceto gratis en minutos para que veas el estilo antes de comprometerte.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
              ...
              className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 text-sm font-semibold tracking-widest uppercase hover:bg-primary-hover transition-colors"
            >
              Quiero mi invitación para Mérida
            </a>
          </div>
        </section>
