...
export const metadata: Metadata = {
  ...
  keywords: [
    "invitaciones digitales saltillo",
    "invitaciones boda saltillo",
    "invitaciones xv años saltillo",
    "invitaciones digitales coahuila",
...
const benefits = [
  {
    title: "Vecinos del noreste, servicio de confianza",
    desc: "Saltillo y Monterrey son ciudades hermanas separadas por una hora de carretera. Esa cercanía cultural se nota en nuestros diseños: entendemos tu estilo, tus tradiciones norteñas y lo que esperas de una invitación elegante.",
  },
  {
    title: "RSVP sin rodeos",
    desc: "En el norte somos directos — y tu invitación también lo será. Tus invitados confirman con un botón, tú recibes la respuesta en WhatsApp y listo. Sin vueltas, sin seguimientos manuales.",
  },
  {
    title: "Entrega digital en 24 horas",
    desc: "Nos escribes por WhatsApp, nos das los datos y al día siguiente tu invitación está lista. Aunque somos de Monterrey, el servicio digital elimina cualquier barrera — como si estuviéramos en Saltillo.",
  },
  {
    title: "Cambios al instante, sin cargos",
    desc: "¿Se modificó algo? Actualizamos tu invitación de inmediato. Tus invitados abren el mismo enlace y ven la información corregida automáticamente. Cero reenvíos, cero confusión.",
  },
]
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Invitaciones Digitales Saltillo",
  provider: {
    "@type": "LocalBusiness",
  ...
  areaServed: { "@type": "City", name: "Saltillo" },
  description:
    "Invitaciones digitales para bodas, XV años y eventos en Saltillo, Coahuila con RSVP automático y entrega en 24 horas.",
  url: "https://invitacionesdigitalesmty.com.mx/saltillo",
}
...
export default function InvitacionesDigitalesSaltilloPage() {
  return (
    <>
      <script
          ...
          <div className="container mx-auto px-6 md:px-10 max-w-7xl flex-1 flex flex-col justify-between">
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="text-[11px] tracking-[0.3em] text-muted-foreground uppercase font-medium">
                Servicio 100% en línea desde Monterrey para Saltillo
              </span>
            </div>
            ...
            >
              Invitaciones<br />
              Digitales<br />
              <em className="italic text-primary">Saltillo</em>
            </h1>
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12 border-t border-border pt-10">
              <div className="flex flex-col gap-8 max-w-md">
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  Saltillo y Monterrey comparten raíces, clima y la forma de celebrar en grande. Diseñamos invitaciones digitales con la calidez norteña que conoces — te atendemos por WhatsApp como vecinos que somos, entregamos en 24 horas y el boceto inicial es gratis.
                </p>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-6 md:px-10 max-w-7xl">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-16">
              Del noreste para el noreste — invitaciones con identidad
            </h2>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-6 md:px-10 max-w-7xl text-center">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">
              Saltillo celebra con todo — y tu invitación debe estar a la par
            </h2>
            <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">
              Mándanos un WhatsApp con los datos de tu evento. Te regresamos un boceto gratis personalizado en menos de 5 minutos. Así de fácil.
            </p>
            <a
              href={whatsappUrl}
              target="_blank"
