      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-6 md:px-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-gray-900 mb-6">
            Creamos Invitaciones con <span className="text-[#1e3a8a]">Pasión</span>
          </h1>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <Icon className="w-8 h-8 text-[#1e3a8a] mx-auto mb-3" />
        ...
        <div className="container mx-auto px-6 md:px-10">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#1e3a8a] text-white p-4 rounded-xl shadow-lg">
                <p className="text-2xl font-bold">Desde 2021</p>
                <p className="text-blue-200 text-sm">Haciendo eventos memorables</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative">
              ...
              {timeline.map((item, index) => (
                ...
                >
                  {/* Dot */}
                  <div className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#1e3a8a] rounded-full border-4 border-white shadow z-10" />
                  
                  {/* Content */}
                  <div className={`ml-12 md:ml-0 md:w-1/2 ${
                    index % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"
                  }`}>
                    <Badge className="mb-2 bg-[#1e3a8a] text-white">{item.year}</Badge>
