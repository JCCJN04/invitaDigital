    ...
    <main className="min-h-screen bg-[#fdfcfb] py-24">
      <div className="container mx-auto px-6 md:px-10 max-w-3xl">
        ...
        <div className="prose prose-stone max-w-none text-[#4a4a4a] space-y-6 font-serif">
          ...
          <p>Para dudas sobre estos términos: WhatsApp <a href="https://wa.me/528180836435" target="_blank" rel="noopener noreferrer" className="text-[#d4a373] hover:underline">+52 81 8083 6435</a>.</p>
        </div>
      </div>
    </main>
  )
