...
export function StickyCTABar() {
  ...
  const whatsappUrl = `https://wa.me/528180836435?text=${encodeURIComponent(
    "Hola, me gustaría cotizar mi invitación digital personalizada."
  )}`
  ...
  return (
    ...
    >
      {/* Gradient fade */}
      <div className="h-4 bg-gradient-to-t from-[#1c1917] to-transparent" />

      {/* Bar */}
      <div className="bg-[#1c1917] border-t border-white/10 px-4 pb-[env(safe-area-inset-bottom,8px)] pt-3">
        <a
          href={whatsappUrl}
          target="_blank"
