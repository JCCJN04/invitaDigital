...
export function HeroSection() {
  const whatsappUrl = "https://wa.me/TUNUMERO?text=Hola%2C%20me%20gustar%C3%ADa%20solicitar%20un%20dise%C3%B1o."
      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-white text-sm font-medium">Diseños Exclusivos 2024</span>
          </div>
