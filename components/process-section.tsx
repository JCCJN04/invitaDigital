...
const whatsappQuoteUrl =
  "https://wa.me/528180836435?text=Hola%2C%20me%20gustar%C3%ADa%20cotizar%20mi%20invitaci%C3%B3n%20digital.%20%C2%BFC%C3%B3mo%20empezamos%3F"
        ...
        <div className="mt-24 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-border pt-12 animate-fade-in-up" style={{ animationDelay: "480ms", opacity: 0, animationFillMode: "forwards" }}>
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Atención directa por WhatsApp. Entregamos tu invitación lista en 24 a 48 horas.
            </p>
          </div>
          <a
            href={whatsappQuoteUrl}
